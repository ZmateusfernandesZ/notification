package com.mateus.notification.business;

import com.mateus.notification.business.dto.TarefasDTO;
import com.mateus.notification.infraestructure.exceptions.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto){
        try{
            ...
            throw new EmailException("Erro ao envia e-mail", e.getCause());
        }
    }
